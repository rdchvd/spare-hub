        ...
        <CardContent className="p-4">
          ...
          <div className="mt-2 flex items-center gap-3 text-xs text-[color:var(--mock-foreground)]">
            <span className="flex items-center gap-1">
              <MapPin className="h-3 w-3" /> {mock.location}
            </span>
            <span className="flex items-center gap-1">
              <Star className="h-3 w-3 fill-[color:var(--gold)] text-[color:var(--gold)]" />{" "}
              {mock.rating} <span className="opacity-60">({mock.reviews})</span>
            </span>
          </div>
          <div className="mt-4 flex items-end justify-between">
            <div>
              ...
              <div
                className={`text-xs truncate max-w-[10rem] ${listing.sellerIsPreview ? "text-[color:var(--mock-foreground)]" : "text-muted-foreground"}`}
              >
                {listing.sellerName}
              </div>
            </div>
