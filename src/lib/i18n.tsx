...
const dict = {
  en: {
    ...
    "products.error.notSeller": "Your account is not linked to a seller profile.",
  ...
  es: {
    ...
    "products.deleted": "Anuncio eliminado",
    "products.delete": "Eliminar anuncio",
    "products.deleteConfirm.body": "Esta acción no se puede deshacer.",
    "products.deleteConfirm.title": "¿Eliminar este anuncio?",
    "products.edit.title": "Editar anuncio",
    "products.edit.subtitle": "Actualiza los campos activos o elimina el anuncio.",
    "products.error.forbidden": "No puedes modificar este anuncio.",
    "products.error.notSeller": "Tu cuenta no está vinculada a un perfil de vendedor.",
    "products.loading": "Cargando anuncios…",
    "products.mock.badge": "Vista previa",
    "products.mock.hint": "Este campo se sincronizará con el catálogo pronto.",
    "products.quantity": "Cantidad",
    "products.saved": "Anuncio guardado",
    ...
    "account.listings.actions.delete": "Eliminar",
    "account.listings.actions.edit": "Editar",
    "account.listings.actions.view": "Ver",
  ...
  uk: {
    ...
    "products.error.notSeller": "Ваш обліковий запис не пов’язаний із профілем продавця.",
