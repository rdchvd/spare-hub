...
const dict = {
  en: {
    ...
    "products.deleted": "Listing deleted",
    "products.delete": "Delete listing",
    "products.deleteConfirm.body": "This cannot be undone.",
    "products.deleteConfirm.title": "Delete this listing?",
    "products.edit.title": "Edit listing",
    "products.edit.subtitle": "Update live fields or remove the listing.",
    "products.error.forbidden": "You cannot change this listing.",
    "products.error.notSeller":
      "You need a seller account to list parts. Create an account with the seller role.",
    "products.loading": "Loading listings…",
    "products.mock.badge": "Preview",
    "products.mock.hint": "This field will sync with the catalog soon.",
    "products.quantity": "Quantity",
    "products.saved": "Listing saved",
    ...
    "account.role.buyer": "Buyer",
    "account.role.seller": "Seller",
    ...
    "account.listings.actions.delete": "Delete",
    "account.listings.actions.edit": "Edit",
    "account.listings.actions.view": "View",
  ...
  uk: {
    ...
    "auth.role": "Я хочу",
    "auth.role.buyer": "Купувати",
    "auth.role.seller": "Продавати",
    ...
    "products.deleted": "Оголошення видалено",
    "products.delete": "Видалити оголошення",
    "products.deleteConfirm.body": "Цю дію не можна скасувати.",
    "products.deleteConfirm.title": "Видалити це оголошення?",
    "products.edit.title": "Редагувати оголошення",
    "products.edit.subtitle": "Оновіть активні поля або видаліть оголошення.",
    "products.error.forbidden": "Ви не можете змінити це оголошення.",
    "products.error.notSeller":
      "Щоб публікувати оголошення, потрібен обліковий запис продавця. Створіть акаунт із роллю продавця.",
    "products.loading": "Завантаження оголошень…",
    "products.mock.badge": "Попередній перегляд",
    "products.mock.hint": "Це поле незабаром синхронізується з каталогом.",
    "products.quantity": "Кількість",
    "products.saved": "Оголошення збережено",

    "browse.results": "{count} результатів",
    ...
    "account.field.email": "Email",
    "account.field.role": "Роль",
    "account.role.admin": "Адмін",
    "account.role.buyer": "Покупець",
    "account.role.seller": "Продавець",
    ...
    "account.listings.actions.delete": "Видалити",
    "account.listings.actions.edit": "Редагувати",
    "account.listings.actions.view": "Переглянути",
